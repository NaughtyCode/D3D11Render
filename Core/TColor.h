...
struct TColor
{
	...
	//inline TColor(const Vec3& c, float fAlpha);
	...
	static inline UINT ComputeAvgCol_Fast( const UINT dwCol0, const UINT dwCol1 )
	{
		UINT dwHalfCol0 = (dwCol0/2) & 0x7f7f7f7f;			// each component /2
		UINT dwHalfCol1 = (dwCol1/2) & 0x7f7f7f7f;			// each component /2
