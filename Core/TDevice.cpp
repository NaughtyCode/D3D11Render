...
int TDevice::CreateFactory(IDXGIFactory** ppDXGIFactory)
{
	HRESULT hr;
...
BOOL TDevice::TestD3D11Device(UINT AdapterIndex,IDXGIAdapter* Adapter,D3D_FEATURE_LEVEL& OutFeatureLevel)
{
...
BOOL TDevice::CheckD3D11Supported(BOOL& SupportD3D11Features)
{
...
void TDevice::GetBestResolution(UINT& Width,UINT& Height)
{
...
IDXGISwapChain* TDevice::GetSwapChain() const
{
	return SwapChain;
}

ID3D11DeviceContext* TDevice::GetDeviceContext() const
{
	return DeviceContext;
}

IDXGIFactory* TDevice::GetFactory() const
{
	return DXGIFactory;
}

HWND TDevice::GetWindowHandle()
{
	return WindowHandle;
}

void TDevice::Present()
{
